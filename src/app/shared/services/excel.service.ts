...
export class ExcelService {
  ...
  excelListadoBandejaTrabajoGestor(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
  ...
  excelListadoConsultas(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
  ...
  excelListadoSolicitudes(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
  ...
  excelListadoSolicitudesFinalizadas(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
  ...
  excelListadoSolicitudesPendientes(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
  ...
  excelListadoSolicitudesEvaluacion(nameSheet: string, nameFile: string, headers: string[], details: any[][]) {
    const workbook = new Workbook();
    const worksheet = workbook.addWorksheet(nameSheet);
